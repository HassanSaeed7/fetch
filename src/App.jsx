...
<h2>Kanye West Quotes</h2>
      <div className="quote-container">
        ...
        <h1>{state}</h1>
        {state ? <div className="name"><h3> — Kanye West</h3></div> : null}
        
        {state ? <button onClick={handleClick}>Anotha One</button> : <button onClick={handleClick}>Gimme That Quote</button>}
      </div>
